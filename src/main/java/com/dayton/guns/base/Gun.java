...
import com.dayton.guns.annotation.Ignored;
import com.dayton.guns.annotation.Optional;
...
import com.dayton.guns.common.helpers.BackpackHelper;
import com.dayton.guns.common.util.GunJsonUtil;
import com.dayton.guns.common.util.SuperBuilder;
...
public class Gun implements INBTSerializable<CompoundTag>, IEditorMenu
{
    ...
    {
        private ResourceLocation item = new ResourceLocation(NukaCraftMod.MOD_ID, "basic_ammo");
        @Optional
