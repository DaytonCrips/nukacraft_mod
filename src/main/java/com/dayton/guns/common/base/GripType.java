...
import com.dayton.guns.client.render.pose.BazookaPose;
import com.dayton.guns.client.render.pose.MiniGunPose;
import com.dayton.guns.client.render.pose.OneHandedPose;
import com.dayton.guns.client.render.pose.TwoHandedPose;
...
public class GripType
{
     ...
     */
    public static final GripType ONE_HANDED = new GripType(new ResourceLocation(NukaCraftMod.MOD_ID, "one_handed"), new OneHandedPose());

    /**
     * A grip type designed for weapons that are held with two hands, like an assault rifle
     */
    public static final GripType TWO_HANDED = new GripType(new ResourceLocation(NukaCraftMod.MOD_ID, "two_handed"), new TwoHandedPose());

    /**
     * A custom grip type designed for the mini gun simply due it's nature of being a completely
     * unique way to hold the weapon
     */
    public static final GripType MINI_GUN = new GripType(new ResourceLocation(NukaCraftMod.MOD_ID, "mini_gun"), new MiniGunPose());
