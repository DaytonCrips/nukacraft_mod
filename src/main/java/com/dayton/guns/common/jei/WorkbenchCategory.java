...
public class WorkbenchCategory implements IRecipeCategory<WorkbenchRecipe>
{
    ...
    public static final String MATERIALS_KEY = NukaCraftMod.MOD_ID + ".category.workbench.materials";
    ...
    public WorkbenchCategory(IGuiHelper helper)
    {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(ModBlocksClass.WORKBENCH.get()));
