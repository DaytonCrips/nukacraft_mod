...
import com.dayton.guns.common.foundation.particles.TrailData;
...
{
    public static final DeferredRegister<ParticleType<?>> REGISTER = DeferredRegister.create(ForgeRegistries.PARTICLE_TYPES, NukaCraftMod.MOD_ID);
