...
import com.dayton.guns.client.render.crosshair.Crosshair;
import com.dayton.guns.client.render.crosshair.TechCrosshair;
import com.dayton.guns.client.render.crosshair.TexturedCrosshair;
...
public class CrosshairHandler {
    ...
    private CrosshairHandler() {
        ...
        this.register(new TexturedCrosshair(new ResourceLocation(NukaCraftMod.MOD_ID, "square")));
        this.register(new TexturedCrosshair(new ResourceLocation(NukaCraftMod.MOD_ID, "round")));
        this.register(new TexturedCrosshair(new ResourceLocation(NukaCraftMod.MOD_ID, "arrow")));
        this.register(new TexturedCrosshair(new ResourceLocation(NukaCraftMod.MOD_ID, "dot")));
        this.register(new TexturedCrosshair(new ResourceLocation(NukaCraftMod.MOD_ID, "box")));
        this.register(new TexturedCrosshair(new ResourceLocation(NukaCraftMod.MOD_ID, "hit_marker")));
        this.register(new TexturedCrosshair(new ResourceLocation(NukaCraftMod.MOD_ID, "line")));
        this.register(new TexturedCrosshair(new ResourceLocation(NukaCraftMod.MOD_ID, "t")));
        this.register(new TexturedCrosshair(new ResourceLocation(NukaCraftMod.MOD_ID, "smiley")));
