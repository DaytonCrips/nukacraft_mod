package com.dayton.nukacraft.guns.client.settings;

import com.dayton.nukacraft.guns.Config;
import com.dayton.nukacraft.guns.client.handler.CrosshairHandler;
import com.dayton.nukacraft.guns.client.render.crosshair.Crosshair;
...
public class GunOptions
{
    ...
    public static final ProgressOption ADS_SENSITIVITY = new GunSliderPercentageOption("nukacraft.options.adsSensitivity", 0.0, 1.0, 0.01F, gameSettings -> {
        ...
        return new TranslatableComponent("nukacraft.options.adsSensitivity.format", FORMAT.format(adsSensitivity));
    });

    public static final CycleOption<ResourceLocation> CROSSHAIR = CycleOption.create("nukacraft.options.crosshair", () -> {
    ...
    /*public static final Option CROSSHAIR = CycleOption.create("nukacraft.options.crosshair", () -> {
