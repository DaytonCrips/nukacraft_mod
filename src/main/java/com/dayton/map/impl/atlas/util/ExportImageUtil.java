package com.dayton.map.impl.atlas.util;

import com.dayton.map.impl.atlas.client.*;
import com.dayton.map.impl.atlas.client.gui.ExportUpdateListener;
import com.dayton.map.impl.atlas.core.WorldData;
import com.dayton.map.impl.atlas.marker.DimensionMarkersData;
import com.dayton.map.impl.atlas.marker.Marker;
import com.dayton.map.impl.atlas.marker.MarkersData;
import com.dayton.map.impl.atlas.registry.MarkerRenderInfo;
...
public class ExportImageUtil {
    ...
    public static File selectPngFileToSave(String atlasName) {
        ...
        getListener().setStatusString("gui.nukacraft.export.opening");
        ...
        getListener().setStatusString("gui.nukacraft.export.selectFile");
        frame = new Frame();
    ...
    public static void exportPngImage(WorldData biomeData, DimensionMarkersData globalMarkers,
        ...
        getListener().setHeaderString("gui.nukacraft.export.setup");
        ...
        getListener().setStatusString("gui.nukacraft.export.makingbuffer", outWidth, outHeight);
        ...
        getListener().setStatusString("gui.nukacraft.export.loadingtextures");
        getListener().setProgressMax(-1);
...
//					allTextures.add(type.getIcon());
        ...
        getListener().setHeaderString("gui.nukacraft.export.rendering");
        drawMapToGraphics(
                graphics,
        ...
        try {
            getListener().setHeaderString("");
            getListener().setStatusString("gui.nukacraft.export.writing");
...
//					allTextures.add(type.getIcon());
        ...
        RenderedImage outImage = new RenderedImageScanned(outWidth, outHeight, scanBuffer, graphics -> {
            ...
            getListener().setHeaderString("gui.nukacraft.export.renderstripe", slice + 1, slices);
            drawMapToGraphics(
                    graphics,
                    bgTilesX, bgTilesY, outWidth, outHeight,
                    biomeData, textureImageMap,
                    ...
                    showMarkers, minX, minY,
                    scale, bg_);
            getListener().setStatusString("gui.nukacraft.export.writestripe");
        ...
        try {
            getListener().setHeaderString("gui.nukacraft.export.renderstripe", 1, slices);
            ImageIO.write(outImage, "PNG", file);
            Log.info("Done writing image");
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private static void drawMapToGraphics(Graphics2D graphics,
        ...
        getListener().setStatusString("gui.nukacraft.export.rendering.background");
        ...
        getListener().setStatusString("gui.nukacraft.export.rendering.map");
        ...
        getListener().setStatusString("gui.nukacraft.export.rendering.markers");
        getListener().setProgressMax(-1);
