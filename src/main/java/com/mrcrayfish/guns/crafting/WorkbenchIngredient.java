...
public class WorkbenchIngredient extends Ingredient
{
    ...
    {
        return new WorkbenchIngredient(new ItemValue(new ItemStack(provider)), count);
    }

    public static WorkbenchIngredient of(ItemStack stack, int count)
    {
        return new WorkbenchIngredient(new ItemValue(stack), count);
    }

    public static WorkbenchIngredient of(TagKey<Item> tag, int count)
    {
        return new WorkbenchIngredient(new TagValue(tag), count);
    }
