...
public class WorkbenchRecipeBuilder
{
    ...
    public void build(Consumer<FinishedRecipe> consumer, ResourceLocation id)
    {
        ...
        consumer.accept(new Result(id, this.result, this.count, this.ingredients, this.conditions, this.advancementBuilder, new ResourceLocation(id.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + id.getPath())));
    }
