package com.nukateam.guns.common.debug.screen;

import com.nukateam.guns.common.data.util.ScreenUtil;
...
public class EditorScreen extends Screen {
    private static final ResourceLocation WINDOW_TEXTURE = new ResourceLocation(NukaCraftMod.MOD_ID, "textures/gui/debug.png");
