...
public class PipboyColors {
    public static NbtColor WHITE = new NbtColor(1, 1, 1);
    public static NbtColor GREEN = new NbtColor(0.400f, 0.700f, 0.400f);
    ...
    public static NbtColor VIOLET = new NbtColor(0.647f, 0.290f, 0.718f);
}
