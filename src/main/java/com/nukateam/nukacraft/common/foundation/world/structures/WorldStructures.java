...
public class WorldStructures extends Structure {
    public static final Codec<WorldStructures> CODEC = RecordCodecBuilder.<WorldStructures>mapCodec(instance ->
            instance.group(WorldStructures.settingsCodec(instance),
            ...
            ).apply(instance, WorldStructures::new)).codec();
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!WorldStructures.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return ModStructures.WORLD_STRUCTURE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}
