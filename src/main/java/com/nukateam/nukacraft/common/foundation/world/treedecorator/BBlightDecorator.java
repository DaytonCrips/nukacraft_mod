...
public class BBlightDecorator extends TreeDecorator {
    public static final Codec<BBlightDecorator> CODEC = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(BBlightDecorator::new, (p_69989_) -> {
        return p_69989_.probability;
    }).codec();
    private final float probability;

    public BBlightDecorator(float p_69976_) {
            ...
            $$2.stream().filter((p_69980_) -> {
                ...
                while(var3.hasNext()) {
                    ...
                    if ($$1.nextFloat() <= 0.25F) {
                        ...
                        if (pContext.isAir($$5)) {
                            pContext.setBlock($$5, (BlockState)((BlockState) ModBlocks.BBLIGHTMUSH.get().defaultBlockState().setValue(ResinBlock.FACING, $$32)));
                        }
                    }
                }
