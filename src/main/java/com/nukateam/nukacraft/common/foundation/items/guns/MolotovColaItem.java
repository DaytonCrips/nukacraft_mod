...
import com.nukateam.nukacraft.common.foundation.entities.misc.MolotovColaEntity;
import net.minecraft.sounds.SoundSource;
import net.minecraft.world.entity.LivingEntity;
import net.minecraft.world.item.Item;
import net.minecraft.world.level.Level;

public class MolotovColaItem extends GrenadeItem {
    public MolotovColaItem(Item.Properties properties, int maxCookTime) {
        super(properties, maxCookTime);
    }

    @Override
    public ThrowableGrenadeEntity create(Level world, LivingEntity entity, int timeLeft) {
        return new MolotovColaEntity(world, entity, timeLeft);
    }
