...
public class ModFeatures {
    public static final Holder<ConfiguredFeature<BlockStateConfiguration, ?>> DISK_ASHSTONE = FeatureUtils.register("disk_ashstone",
            Feature.FOREST_ROCK,
    ...
    public static final Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> LAKE_ACID = FeatureUtils.register("lake_acid",
            Feature.LAKE,
