...
public class DewdropDecorator extends TreeDecorator {
    public static final Codec<DewdropDecorator> CODEC = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(DewdropDecorator::new, (p_69989_) -> {
        return p_69989_.probability;
    }).codec();
    private final float probability;

    public DewdropDecorator(float p_69976_) {
            ...
            $$2.stream().filter((p_69980_) -> {
                ...
                while (var3.hasNext()) {
                    ...
                    if ($$1.nextFloat() <= 0.25F) {
                        ...
                        if (pContext.isAir($$5)) {
                            pContext.setBlock($$5, (ModBlocks.DEWDROPHEAD.get().defaultBlockState().setValue(DewdropBlock.FACING, $$32)));
                        }
                    }
                }
